  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        pill: {
          "new-bg": "var(--pill-new-bg)",
          "new-text": "var(--pill-new-text)",
          "collab-bg": "var(--pill-collab-bg)",
          "collab-text": "var(--pill-collab-text)",
          "anniversary-bg": "var(--pill-anniversary-bg)",
          "anniversary-text": "var(--pill-anniversary-text)",
          "early-access-bg": "var(--pill-early-access-bg)",
          "early-access-text": "var(--pill-early-access-text)",
          "special-bg": "var(--pill-special-bg)",
          "special-text": "var(--pill-special-text)",
          "vip-deal-bg": "var(--pill-vip-deal-bg)",
          "vip-deal-text": "var(--pill-vip-deal-text)",
        },
      },
      borderRadius: {
        none: "0px",
