    ...
    <div className="bg-neutral-100 p-2 rounded-lg border">
      <div className="space-y-1.5">
        ...
        <div className="flex justify-between gap-1">
          <div
            className={clx(
              "bg-gradient-to-r from-zinc-400 to-zinc-500 h-1 rounded-lg max-w-full duration-500 ease-in-out",
              {
          ...
          ></div>
          <div className="bg-neutral-300 h-1 rounded-lg w-fit flex-grow"></div>
        </div>
      </div>
    </div>
  )
...
function FreeShippingPopup({
  ...
  return (
    ...
    >
      <div>
        <Button
          className="rounded-lg bg-neutral-900 shadow-none outline-none border-none text-[15px] p-2"
        ...
        <div className="pb-4">
          <div className="space-y-3">
            ...
            <div className="flex justify-between gap-1">
              <div
                className={clx(
                  "bg-gradient-to-r from-zinc-400 to-zinc-500 h-1.5 rounded-lg max-w-full duration-500 ease-in-out",
                  {
                    "from-green-400 to-green-500": price.target_reached,
                  },
                )}
                style={{ width: `${price.remaining_percentage}%` }}
              ></div>
              <div className="bg-zinc-600 h-1.5 rounded-lg w-fit flex-grow"></div>
            </div>
          </div>
        </div>
