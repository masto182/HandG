      ...
      <div className="bg-hg-surface border border-hg-border rounded-xl p-6 mb-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-bold text-hg-text mt-1">
              #{orderNumber}
            </p>
          </div>
          ...
          {isPayid && (
            <div className="border border-hg-gold/50 rounded-full px-3 py-1">
              <span className="text-[10px] font-semibold text-hg-gold uppercase tracking-widest">
                Order Pending PayID
              </span>
            </div>
          )}
      ...
      {isPayid && (
        <div className="bg-hg-surface border border-hg-border rounded-xl p-6 mb-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl font-bold text-hg-text">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-hg-bg border border-hg-border rounded-xl">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="font-semibold text-sm text-hg-text">
                  Login to your banking app
                </h3>
              </div>
              <p className="text-sm text-hg-text-secondary ml-9">
                Select &apos;Pay Someone&apos; and choose PayID as the payment
                method.
              </p>
            </div>
            ...
            <div className="p-4 bg-hg-bg border border-hg-border rounded-xl">
              ...
              <div className="ml-9 mt-2 flex items-center justify-between p-3 bg-hg-surface border border-hg-border rounded-lg">
                <span className="text-sm font-bold text-hg-text">
                  {orderNumber}
                </span>
                <button
          ...
          <p className="text-xs text-hg-text-muted italic mt-6 text-center">
            Orders are typically verified and moved to &apos;Fulfilment&apos;
            within 1-2 business hours of payment receipt. Your items are held
            for {holdHours} hours.
            {ordersEmail
