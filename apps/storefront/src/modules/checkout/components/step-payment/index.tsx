...
const StepPayment: React.FC<Props> = ({
  ...
  const defaultSelected =
    ...
    (!isPickup && filteredMethods.length === 1
  ...
  return (
    <div>
      <div className="mb-10">
        <h1 className="text-h1 text-hg-text">Payment Options</h1>
      </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-8">
          {filteredMethods.map((pm) => {
            ...
            return (
              ...
              >
                <div
                  className={`w-10 h-10 rounded-lg flex items-center justify-center ${isActive ? "bg-hg-gold/20 text-hg-gold" : "bg-hl-surface3 text-hg-text-secondary"}`}
                >
                  {isPayid ? (
                    <svg
                      width="20"
                ...
                <div className="text-left">
                  <h3 className="text-sm font-semibold text-hg-text">
                    {isPayid ? "PayID Transfer" : "Cash on Pickup"}
                  </h3>
      ...
      {isPayidSelected && (
        <div className="bg-hg-surface border border-hg-border rounded-xl p-6 mb-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h3 className="text-xl font-bold text-hg-text">
                PayID Payment Details
              </h3>
              <p className="text-sm text-hg-text-secondary">
                Please use the details below in your banking app.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-8">
            <div className="text-center">
              ...
              <p className="text-xs text-hg-text-secondary mt-2">
                Log into your mobile banking app or online portal.
              </p>
            </div>
            <div className="text-center">
              <span className="text-2xl font-bold text-hg-text-muted">02</span>
              <p className="text-xs text-hg-text-secondary mt-2">
                Select &apos;Pay Someone&apos; using PayID and enter the details
                above.
              </p>
            </div>
            <div className="text-center">
          ...
          <div className="mt-6 flex items-start gap-3 p-4 bg-hg-bg rounded-lg border border-hg-border">
            <svg
              ...
              stroke="currentColor"
              strokeWidth="1.5"
              className="text-hg-gold shrink-0 mt-0.5"
            >
