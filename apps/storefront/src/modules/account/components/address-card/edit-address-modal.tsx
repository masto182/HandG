    ...
    <>
      ...
      >
        <div className="flex flex-col">
          ...
          {address.company && (
            <Text
              className="txt-compact-small text-on-surface-variant"
        ...
        <div className="flex items-center gap-x-4 border-t border-white/5 pt-4">
          <button
            className="text-label-caps uppercase tracking-[0.05em] text-primary hover:underline transition-all"
            onClick={open}
          ...
          <button
            className="text-label-caps uppercase tracking-[0.05em] text-error hover:underline transition-all"
            onClick={removeAddress}
            data-testid="address-delete-button"
          >
            {removing ? <Spinner /> : <Trash className="inline mr-1" />}
            Remove
          </button>
        </div>
      </div>
