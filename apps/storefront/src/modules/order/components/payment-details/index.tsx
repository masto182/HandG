  ...
  return (
    <div>
      ...
      <div>
        {payment && (
          <div>
            <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-x-1 w-full mb-4">
            ...
            {isPayid && (
              <div className="rounded-lg border border-hg-border bg-hg-bg p-5 space-y-3">
                <Text className="txt-medium-plus text-hg-text">
                  PayID Details
                </Text>
            ...
            {isCash && (
              <div className="rounded-lg border border-hg-border bg-hg-bg p-5">
                <Text className="txt-medium text-hg-text-secondary">
                  Pay with cash when you collect your order. Payment is due at
                  pickup.
                </Text>
              </div>
            )}
