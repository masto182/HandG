            ...
            <>
              <div className="relative flex h-full">
                <PopoverButton
                  ...
                  className="relative h-full flex items-center transition-all ease-out duration-200 outline-none focus-visible:ring-2 focus-visible:ring-hg-gold focus-visible:ring-offset-1 rounded hover:text-hg-gold text-hg-text-secondary"
                >
                  <svg
                    width="20"
                    height="20"
                  ...
                  <>
                    ...
                    >
                      <div className="flex items-center justify-between px-6 h-16 border-b border-hg-border">
                        <span className="text-hg-gold font-bold text-lg">
                          Hops & Glory
                        </span>
                        <button
                        ...
                        <ul className="flex flex-col gap-1">
                          ...
                          <li>
                            ...
                            >
                              ...
                              <span className="font-medium">Hops</span>
                            </LocalizedClientLink>
                          </li>
                          {isApproved && (
                            <li>
