...
export const metadata: Metadata = {
  ...
  description:
    "How we deliver rare releases to your door — fast, protected, and intact.",
}
...
export default async function ShippingPage() {
  ...
  return (
    <div className="content-container py-12 max-w-3xl mx-auto">
      <h1 className="text-3xl font-bold text-hg-text mb-2">
        Shipping & Delivery
      </h1>
      <p className="text-hg-text-secondary mb-10">
      ...
      <div className="flex flex-col gap-8">
        <section>
          <h2 className="text-lg font-semibold text-hg-text mb-3">
            Live carrier rates
          </h2>
          <p className="text-sm text-hg-text-secondary leading-relaxed">
            We ship Australia-wide via Australia Post, CouriersPlease, and
            Aramex Australia. At checkout we quote each enabled carrier in real
            time and automatically pick the cheapest available rate for your
            shipment. Express options are surfaced when delivery time matters
            more than cost.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="bg-hg-surface border border-hg-border rounded-xl p-5">
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
                <p className="text-hg-text font-medium">
                  Metro (VIC, NSW, QLD)
                </p>
        ...
        <section>
          ...
          <p className="text-sm text-hg-text-secondary leading-relaxed">
            You&apos;ll receive a tracking number via email once your order is
            dispatched. Real-time tracking is available through the link in your
            confirmation email or via your account under Orders.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-sm text-hg-text-secondary leading-relaxed">
            Prefer to collect? Pickup is free at our Hillside location during
            scheduled windows. Choose pickup at checkout to skip shipping fees
            entirely.
          </p>
        </section>
      </div>
