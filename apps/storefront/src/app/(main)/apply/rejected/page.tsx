      ...
      <div className="max-w-md text-center flex flex-col items-center">
        <div className="bg-surface-container border border-outline-variant rounded-2xl p-10 w-full">
          ...
          <p className="text-body-md text-on-surface-variant mb-8">
            Thank you for your interest in Hops &amp; Glory. Unfortunately,
            we&apos;re not able to approve your application at this time. This
            isn&apos;t necessarily permanent — we encourage you to apply again
            in the future.
          </p>
