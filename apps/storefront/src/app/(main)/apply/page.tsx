...
export const metadata: Metadata = {
  ...
  description:
    "Apply to join the most exclusive private collection of limited-release cans.",
}
    ...
    <main>
      <section className="relative min-h-[400px] w-full overflow-hidden flex flex-col items-center justify-center text-center px-6 py-24">
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          <span className="text-label-caps uppercase tracking-[0.2em] text-primary mb-4 block">
            MEMBERS ONLY
          </span>
          <h1 className="text-h1 text-on-surface mb-4">
            A club you earn your way into
          </h1>
        ...
        <div className="max-w-[560px] mx-auto">
          <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 mb-10">
            <div className="flex items-center gap-2 bg-primary-container/20 px-4 py-1.5 rounded-full border border-primary/30">
              <span className="w-6 h-6 rounded-full bg-primary text-on-primary text-[12px] font-bold flex items-center justify-center">
                1
              </span>
              <span className="text-label-caps text-primary">Apply</span>
            </div>
            <div className="h-px w-4 sm:w-8 bg-outline-variant/30" />
            <div className="flex items-center gap-2 px-4 py-1.5 rounded-full border border-outline-variant/30 opacity-50">
              <span className="w-6 h-6 rounded-full bg-surface-container-high text-on-surface-variant text-[12px] font-bold flex items-center justify-center">
                2
              </span>
          ...
          <div className="bg-surface-container-low p-8 rounded-xl border border-outline-variant/20 shadow-lg">
            <Suspense
              fallback={
                <div className="w-full h-96 animate-pulse bg-surface-container rounded-lg" />
              }
            >
              <ApplyForm />
            </Suspense>
