...
export default function NotFound() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-64px)] px-6 text-center relative">
      <div className="relative mb-10 h-20 w-20 flex items-center justify-center text-on-surface-variant">
        ...
        >
          <path
            d="M7 5V19C7 20.1046 7.89543 21 9 21H15C16.1046 21 17 20.1046 17 19V5C17 3.89543 16.1046 3 15 3H9C7.89543 3 7 3.89543 7 5Z"
            stroke="currentColor"
            strokeLinecap="round"
            strokeWidth="1.2"
          />
          <path
            d="M7 6H17M9 3.5V4.5M15 3.5V4.5"
            stroke="currentColor"
            strokeLinecap="round"
            strokeWidth="1.2"
          />
